...
use crate::{db::DatabaseTrait, sensors::interface::SensorController, watering::ds::AppState};

pub async fn list_devices<C: SensorController, D: DatabaseTrait>(
...
pub async fn query_weather<C: SensorController, D: DatabaseTrait>(
    State(_app_state): State<Arc<AppState<C, D>>>,
